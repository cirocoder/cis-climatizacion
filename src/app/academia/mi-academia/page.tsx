  ...
  return <section className="academy-section account-section">
    <div className="academy-container account-shell">
      <header className="account-heading">
        ...
        <article className="account-card"><div><span>Cuenta {user.emailVerified ? "verificada" : "pendiente de verificación"}</span><h2>{user.email}</h2></div><LogoutButton/></article>
      </header>
